function [p_temp] = AdjustPressure_for5seg_YZ ( dthetadest, ddisdest, dxdest, k_dpdtheta, k_dpddis, k_dpdy,p_now, stateone )
    p_temp = zeros(1,16);
    ...
    %k_dpdy  tai da le 
%     difinx =(4*(p_temp(2)+p_temp(1)-p_temp(4)-p_temp(3))+ 5*(p_temp(6)+p_temp(5)-p_temp(8)-p_temp(7)) + 7*(p_temp(10)+p_temp(9)-p_temp(12)-p_temp(11)) + 18*(p_temp(13)-p_temp(14)) ) * k_dpdy;       %ע�����ڵ��������������
    ...
    dp_y = dp_y * 1;
    temp = [-stateone(4,3), stateone(4,2)];
    UvectorY1 = temp / sqrt(temp * temp');
    temp = [-stateone(3,3), stateone(3,2)];
    UvectorY2 = temp / sqrt(temp * temp');
    temp = [-stateone(2,3), stateone(2,2)];
    UvectorY3 = temp / sqrt(temp * temp');
    temp = [-stateone(1,3), stateone(1,2)];
    UvectorY4 = temp / sqrt(temp * temp');
    temp = [-stateone(5,3), stateone(5,2)];
    UvectorY = temp / sqrt(temp * temp');

    p_temp(1) =  p_temp(1) + UvectorY * UVectorY1' * dp_y;
    p_temp(2)=  p_temp(2) + UvectorY * UVectorY1' * dp_y;
    p_temp(3)=  p_temp(3) - UvectorY * UVectorY1' * dp_y;
    p_temp(4)=  p_temp(4) - UvectorY * UVectorY1' * dp_y;
    p_temp(5)=  p_temp(5) + UvectorY * UVectorY2' * dp_y;
    p_temp(6) =  p_temp(6) + UvectorY * UVectorY2' * dp_y;
    p_temp(7) = p_temp(7) - UvectorY * UVectorY2' * dp_y;
    p_temp(8) = p_temp(8) - UvectorY * UVectorY2' * dp_y;
    p_temp(9)=  p_temp(9) + UvectorY * UVectorY3' * dp_y;
    p_temp(10) =  p_temp(10) + UvectorY * UVectorY3' * dp_y;
    p_temp(11) = p_temp(11) - UvectorY * UVectorY3' * dp_y;
    p_temp(12) = p_temp(12) - UvectorY * UVectorY3' * dp_y;
    %3
    p_temp(13) = p_temp(13) + UvectorY * UVectorY4' * 3*dp_y;
    p_temp(14) = p_temp(14) - UvectorY * UVectorY4' * 3*dp_y;