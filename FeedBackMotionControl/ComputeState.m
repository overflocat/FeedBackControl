function [currentState] = ComputeState( body1, body2, body3, body4, body5, body6 )
    ...
    [coordinate1, ~, ~] = deal_tran( mCenter, mX, mY, mZ, center1, vz1 );
    [coordinate2, ~, ~] = deal_tran( mCenter, mX, mY, mZ, center2, vz2 );
    [coordinate3, ~, ~] = deal_tran( mCenter, mX, mY, mZ, center3, vz3 );
    [coordinate4, ~, ~] = deal_tran( mCenter, mX, mY, mZ, center4, vz4 );
    [coordinate5, ~, ~] = deal_tran( mCenter, mX, mY, mZ, center5, vz5 );    

    currentState = 1000 * [coordinate5; coordinate4; coordinate3; coordinate2; coordinate1];
